...
const drinks: Drink[] = [
  ...
  // ... (copie les autres boissons du texte si tu veux)
];

const router = Router();

// La route pour lire le menu (GET /)
router.get("/", (_req, res) => {
    console.log(new Date().toLocaleDateString("fr-FR", { timeZone: "Europe/Brussels" })+"\n"+new Date().toLocaleTimeString("fr-FR", { timeZone: "Europe/Brussels" })
);
